...
var AnimationComponent = function (_Component) {
    ...
    function AnimationComponent() {
        ...
        var _this = _possibleConstructorReturn(this, (AnimationComponent.__proto__ || Object.getPrototypeOf(AnimationComponent)).apply(this, arguments));
    ...
    _createClass(AnimationComponent, [{
        ...
        value: function $update(args) {
            if (this._ready) this._update(args.timer);
        }
    }, {
        key: "$render",
        ...
        value: function _update(timer) {
            for (var key in this.clips) {
                ...
                var t = this.currentTime + this.timeOffset;
                var animationTime = this.loop ? t % length : Math.max(t, length);
...
var __VERSION__ = exports.__VERSION__ = "1.4.1";
var __NAME__ = exports.__NAME__ = "grimoirejs-animation";
