    ...
    _createClass(NormalComplementorModule, [{
        ...
        value: function complementVertexAttributes(args) {
            if (args.primitive.attributes["NORMAL"] === void 0 && args.primitive.attributes["POSITION"] !== void 0) {
                ...
                if (defaultAccessor) {
                    var defaultBufferView = args.tf.bufferViews[defaultAccessor.bufferView];
                    var bufferSource = args.bufferViews[defaultAccessor.bufferView];
                    var byteAccessor = this.__getBufferReader(bufferSource, defaultAccessor.componentType, defaultAccessor.byteOffset, defaultBufferView.byteStride);
        ...
        value: function __instanciateNode(recipe, nodeName, instanciatedNodes, parent, model) {
            ...
            if (node.skin !== void 0) {
                this._skinInstanciators.push(function () {
                    ...
                    var offset = !invBindShapeMatrixSourceAccessor.byteOffset ? 0 : invBindShapeMatrixSourceAccessor.byteOffset;
                    var getInvBindShapeElement = function getInvBindShapeElement(i) {
                        return invBindShapeMatrixSourceCasted[offset / 4 + stride / 4 * i];
                    };
