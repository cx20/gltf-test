        ...
        value: function __instanciateNode(recipe, nodeName, instanciatedNodes, parent, model) {
            ...
            if (node.mesh !== void 0) {
                ...
                if (primitives.length === 1) {
                    ...
                    var matMeta = recipe.tf.materials[meshInfo.primitives[0].material];
                    ...
                    for (var i = 0; i < primitives.length; i++) {
                        ...
                        var _matMeta = recipe.tf.materials[meshInfo.primitives[i].material];
                        var _meshNode = objectNode.addChildByName("mesh", {
                            geometry: primitives[i],
                            material: _mat,
                            cull: _matMeta.doubleSided ? "none" : "back"
                        });
