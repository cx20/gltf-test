...
var _Color3 = __webpack_require__(23);
...
var _TransformComponent = __webpack_require__(6);
...
var _MorphGeometry = __webpack_require__(26);
...
var _TextureReference = __webpack_require__(27);
            ...
            for (var attrib in args.primitive.attributes) {
                ...
                if (args.primitive.targets !== void 0 && args.primitive.targets[0][attrib] !== void 0) {
                    ...
                    for (var i = 0; i < targets.length; i++) {
                        ...
                        parameters.push({
                            buffer: this.__convertBufferView(Float32Array, buffer, _bufferViewInfo, _accessor),
                            accessor: {
...
var ParserModuleBase = function () {
    ...
    _createClass(ParserModuleBase, [{
        ...
        value: function __convertBufferView(ctor, bufferView, bufferViewInfo, accessor) {
            ...
            return new ctor(bufferView.buffer, offset, accessor.count * _ConstantConverter2.default.asVectorSize(accessor.type));
        }
    }, {
        key: "__fetchBuffer",
...
var _MeshRendererComponent = __webpack_require__(17);

var _MeshRendererComponent2 = _interopRequireDefault(_MeshRendererComponent);

var _Quaternion = __webpack_require__(28);
...
var _AnimationFactory = __webpack_require__(29);
...
var _GLTFJointComponent = __webpack_require__(4);
...
var _GLTFVertexMorpher = __webpack_require__(18);
...
var _ResourceResolver = __webpack_require__(30);
...
var _grimoirejs = __webpack_require__(19);

var _grimoirejs2 = _interopRequireDefault(_grimoirejs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var __VERSION__ = "2.3.1";
...
var _HashCalculator = __webpack_require__(32);
...
var _UniformResolverRegistry = __webpack_require__(34);
...
var _ImportResolver = __webpack_require__(37);

var _ImportResolver2 = _interopRequireDefault(_ImportResolver);

var _GLExtRequestor = __webpack_require__(38);
