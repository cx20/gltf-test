...
var _MeshRendererComponent = __webpack_require__(24);

var _MeshRendererComponent2 = _interopRequireDefault(_MeshRendererComponent);

var _Quaternion = __webpack_require__(33);
...
var _AnimationFactory = __webpack_require__(22);
    ...
    _createClass(DefaultParserModule, [{
        ...
        value: function loadAnimation(args) {
            ...
            for (var i = 0; i < args.animation.channels.length; i++) {
                ...
                var arrays = [];
                for (var _i2 = 0; _i2 < elemCount; _i2++) {
                    arrays.push([]);
                }
                for (var _i3 = 0; _i3 < outputAccessor.count; _i3++) {
                    for (var j = 0; j < elemCount; j++) {
                        arrays[j].push(outputBufferF32[_i3 * elemCount + j]); // SHould consider buffer stride
                    }
                }
...
var _Accessor = __webpack_require__(18);
...
var _ResourceResolver = __webpack_require__(19);
...
var __VERSION__ = "0.0.10-development";
