    ...
    _createClass(DefaultParserModule, [{
        ...
        value: function addVertexAttributes(args) {
            for (var attrib in args.primitive.attributes) {
                ...
                var bufferView = args.tf.bufferViews[accessor.bufferView];
                var bufAccessor = {};
                bufAccessor[attrib] = {
