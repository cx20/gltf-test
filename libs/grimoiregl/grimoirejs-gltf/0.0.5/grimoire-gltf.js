...
var _Color3 = __webpack_require__(29);
...
var _Interpolators = __webpack_require__(3);
...
var _Matrix = __webpack_require__(31);
...
var _DefaultInstanciator = __webpack_require__(7);
    ...
    _createClass(DefaultInstanciator, [{
        ...
        value: function __applyTransform(node, nodeInfo) {
            if (nodeInfo.rotation) {
                node.setAttribute("rotation", new _Quaternion2.default([].concat(nodeInfo.rotation)));
            }
            if (nodeInfo.translation) {
                node.setAttribute("position", new _Vector2.default([].concat(nodeInfo.translation)));
            }
            if (nodeInfo.scale) {
                node.setAttribute("scale", new _Vector2.default([].concat(nodeInfo.scale)));
            }
        }
    }]);
...
var _ParserModule2 = __webpack_require__(10);
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _context4.next = 3;
                                return _MaterialFactory2.default.get(this.__gl).instanciate("gltf-pbr-metalic-roughness");
...
GLTFParser.parserModules = [_DefaultParserModule2.default];
...
var _ParserModuleBase2 = __webpack_require__(11);
...
var _TextFileResolver = __webpack_require__(21);
...
var _HashCalculator = __webpack_require__(27);
...
var _GLTFAnimationComponent = __webpack_require__(4);

var _GLTFAnimationComponent2 = _interopRequireDefault(_GLTFAnimationComponent);

var _GLTFModelComponent = __webpack_require__(6);
...
var _UniformResolverRegistry = __webpack_require__(23);

var _UniformResolverRegistry2 = _interopRequireDefault(_UniformResolverRegistry);

var _gltfUnlit = __webpack_require__(34);

var _gltfUnlit2 = _interopRequireDefault(_gltfUnlit);

var _gltfPbrMetalicRoughness = __webpack_require__(33);

var _gltfPbrMetalicRoughness2 = _interopRequireDefault(_gltfPbrMetalicRoughness);
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _MaterialFactory2.default.addSORTMaterial("gltf-pbr-metalic-roughness", _gltfPbrMetalicRoughness2.default);
...
var _Accessor = __webpack_require__(17);
...
var _ParserModule = __webpack_require__(10);

var _ParserModule2 = _interopRequireDefault(_ParserModule);

var _ParserModuleBase = __webpack_require__(11);

var _ParserModuleBase2 = _interopRequireDefault(_ParserModuleBase);

var _ResourceResolver = __webpack_require__(18);
...
var __VERSION__ = "0.0.4-development";
