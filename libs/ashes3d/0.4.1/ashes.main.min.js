...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
function kt(e,t,n,r){return new(n||(n=Promise))((function(i,a){function o(e){try{l(r.next(e))}catch(e){a(e)}}function s(e){try{l(r.throw(e))}catch(e){a(e)}}function l(e){e.done?i(e.value):new n((function(t){t(e.value)})).then(o,s)}l((r=r.apply(e,t||[])).next())}))}Wt.list={},Wt.platform="unknown";class Xt{constructor(){this.worldPos=I(0,0,0),this.translate=I(0,0,0),this.rotate=I(0,0,0),this.scale=I(1,1,1),this.quaternion=oe(0,0,0,1),this.localMatrix=h(),this.worldMatrix=h(),this.worldInverseMatrix=h(),this.worldNormalMatrix=h(),this.isVisible=!0,this.isDirty=!1,v(this.localMatrix),v(this.worldMatrix)}static clone(e){let t=new Xt;return C(t.translate,e.translate),C(t.rotate,e.rotate),C(t.scale,e.scale),se(t.quaternion,e.quaternion),t}}Ft.getDefaultComponent=()=>new Xt,Ft.cloneMethods._Transform=Xt.clone;class qt extends Pt{constructor(){super(...arguments),this.group=[],this.depends=[Xt.name]}onUpdate(){for(let{components:e}of this.group)qt.updateMatrix(e.Transform)}static decomposeMatrix(e,t=e.localMatrix){w(e.translate,t[0],t[1],t[2]);let n=ee(e.translate);w(e.translate,t[4],t[5],t[6]);let r=ee(e.translate);w(e.translate,t[8],t[9],t[10]);let i=ee(e.translate);w(e.scale,n,r,i),g(t)<0&&(n=-n),w(e.translate,t[12],t[13],t[14]),t[12]=t[13]=t[14]=0,t[0]/=n,t[1]/=n,t[2]/=n,t[4]/=r,t[5]/=r,t[6]/=r,t[8]/=i,t[9]/=i,t[10]/=i,x(e.quaternion,t)}static updateMatrix(e){e.isDirty=!1,_(e.localMatrix,e.quaternion,e.translate,e.scale),b(e.worldInverseMatrix,e.worldMatrix),p(e.worldNormalMatrix,e.worldInverseMatrix);let t=e.entity.parentElement;if(null!=t&&t.components){let n=t.components.Transform;S(e.worldMatrix,n.worldMatrix,e.localMatrix),q(e.worldPos,e.translate,e.worldMatrix)}else d(e.worldMatrix,e.localMatrix)}}Dt.registSystem(new qt);class jt{constructor(){this.ibm=[],this.jointMat=[]}}Dt.registSystem(new class extends Pt{constructor(){super(...arguments),this.group=[],this.depends=[jt.name]}onUpdate(){for(let{components:e}of this.group){let t=e.Skin,n=e.Transform;for(let[e,r]of t.joints.entries())S(t.jointMat[e],n.worldInverseMatrix,r.worldMatrix),S(t.jointMat[e],t.jointMat[e],t.ibm[e])}}});class Zt{constructor(){this.channels=[]}static attachChannel(e,t){e.channels.push(t),this.totalTime=Math.max(this.totalTime,t.endTime)}}Zt.totalTime=0;class $t{constructor(e,t,n){this.isLoop=!0,this.pause=!1,this.currentTime=0,this.startTime=0,this.endTime=0,this.totalTime=0,this.step=0,this.speed=1,this.channel=e,this.timeline=Lt.newFloat32Array(t),this.endTime=this.timeline[this.timeline.length-1],this.keyframe=Lt.getFloat32Blocks(n),1!=this.timeline.length?this.startTime=this.timeline[0]:this.currentTime=this.endTime}}class Yt extends Pt{constructor(){super(...arguments),this.group=[],this.depends=[Zt.name]}reset(e){e.step=0,e.currentTime=0}static step(e){let t,n,r,i,a=e.channel.length,o=e.step,s=o+1;1==e.timeline.length?(s=0,t=0,e.pause=!0):(t=e.timeline[o],n=e.keyframe[o]),r=e.timeline[s],i=e.keyframe[s];let l=r-t;if(e.currentTime<t||e.currentTime>r)return console.error("Wrong step!",e.currentTime,t,r),void console.log(e.timeline);let c=l?(e.currentTime-t)/l:1;switch(a){case 4:Fe(e.channel,n||this.defaultQuat,i,c);break;case 3:X(e.channel,n||this.defaultVec3,i,c)}}playStep(e,t){if(!e.pause){if(e.currentTime>Zt.totalTime)return this.reset(e),void(e.isLoop||(e.pause=!0,console.log("stop")));for(;e.currentTime>e.timeline[e.step+1];)e.step++;e.currentTime>e.startTime&&e.currentTime<=e.endTime&&Yt.step(e),e.currentTime+=t*e.speed}}onUpdate(e){for(let{components:t}of this.group){e>.016&&(e=.016);let n=t.Animation;for(let t of n.channels)this.playStep(t,e)}}}Yt.defaultQuat=we(),Yt.defaultVec3=O(),Dt.registSystem(new Yt);class Jt{constructor(e){this.scene=Ft.create("scene"),this.gltf=e,e.useHDR=e.hasEnvmap&&null!=e.envmap.data,e.materials||(e.materials=[{name:"Default_Material"}]),e.materials=e.materials.map((t=>{let n=new Gt(e.commonShader,t.name,t.doubleSided);return this.detectConfig(n,t),Gt.setTexture(n,"brdfLUT",e.brdfLUT),e.hasEnvmap&&(n.shader.macros.HAS_ENV_MAP="",e.useHDR&&(n.shader.macros.USE_HDR=""),Gt.setTexture(n,"env",e.envmap),e.diffmap&&(n.shader.macros.HAS_DIFFENV_MAP="",Gt.setTexture(n,"diffenv",e.diffmap))),n})),e.accessors=e.accessors.map((t=>(t.bufferView=e.bufferViews[t.bufferView],new Lt(t)))),e.meshes=e.meshes.map((t=>t.primitives.map((t=>{let{attributes:n,targets:r}=t,i=[];for(let t in n){let r=e.accessors[n[t]];r.attribute=t,i.push(r)}let a=e.accessors[t.indices],o=new yt(i,a,t.mode);null==n.TANGENT&&null!=n.TEXCOORD_0&&(console.warn("Using computed tagent!"),yt.preComputeTangent(o)),null==n.NORMAL&&(console.warn("Using computed normal!"),yt.preComputeNormal(o));let s=e.materials[t.material||0];if(null!=n.JOINTS_0&&(s.shader.macros.HAS_SKINS=""),r){s.shader.macros.HAS_MORPH_TARGETS="",Gt.setUniform(s,"weights",new Float32Array([.5]));for(let t of r)for(let n in t){let r=e.accessors[t[n]];r.attribute="TAR_"+n,o.attributes.push(r)}}return[o,s]}))))}assemble(){return kt(this,void 0,void 0,(function*(){let e=this.gltf,{scene:t,scenes:n,nodes:r,skins:i,animations:a}=e;if(this.entities=e.nodes.map(((e,t)=>this.createEntity(e,t))),i&&(i=i.map((t=>{if(t.joints=t.joints.map((e=>this.entities[e].components.Transform)),null==t.entity)return;let n=new jt;n.materials=t.materials,n.joints=t.joints;let r=e.accessors[t.inverseBindMatrices];n.ibm=Lt.getFloat32Blocks(r),n.outputMat=new Float32Array(r.count*r.size),n.jointMat=Lt.getSubChunks(r,n.outputMat);for(let e of t.transforms){e.jointsMatrices=n.outputMat,e.entity.components.Material.shader.macros.JOINT_AMOUNT=Math.min(t.joints.length,200)}return t.entity&&t.entity.addComponent(n),n}))),a)for(let{channels:t,samplers:n}of a)for(let{sampler:r,target:i}of t){let t,a=this.entities[i.node],o=a.components.Transform;a.components.Material;switch(i.path){case"translation":t=o.translate;break;case"rotation":t=o.quaternion;break;case"scale":t=o.scale}if(null!=t){let{input:i,interpolation:o,output:s}=n[r],l=e.accessors[i],c=e.accessors[s];null==a.components.Animation&&a.addComponent(new Zt);let u=a.components.Animation;Zt.attachChannel(u,new $t(t,l,c))}}let o=n[t||0].nodes;for(let e of o){let t=this.parseNode(e,r);this.scene.appendChild(t)}return console.log(this),this}))}waitEntity(e,t){return new Promise(((n,r)=>{setTimeout((()=>{n(this.createEntity(e,t))}),0)}))}detectTexture(e,t,n){let{index:r,texCoord:i}=n,a=this.gltf;null!=r&&(Gt.setTexture(e,t,a.textures[r]),i&&(e.shader.macros[t+"_uv"]="uv"+i))}detectConfig(e,t){let n=e.shader;for(let r in t){let i=t[r];switch(this.detectTexture(e,r,i),r){case"normalTexture":n.macros.HAS_NORMAL_MAP="";break;case"occlusionTexture":n.macros.HAS_AO_MAP="";break;case"baseColorTexture":n.macros.HAS_BASECOLOR_MAP="";break;case"metallicRoughnessTexture":n.macros.HAS_METALLIC_ROUGHNESS_MAP="";break;case"emissiveTexture":n.macros.HAS_EMISSIVE_MAP="";break;case"baseColorFactor":n.macros.BASECOLOR_FACTOR=`vec4(${i.join(",")})`;break;case"metallicFactor":n.macros.METALLIC_FACTOR=`float(${i})`;break;case"roughnessFactor":n.macros.ROUGHNESS_FACTOR=`float(${i})`;break;case"alphaMode":n.macros[i]="","OPAQUE"!=i&&(e.queue=wt.Blend);break;case"alphaCutoff":n.macros.ALPHA_CUTOFF=`float(${i})`;break;case"pbrMetallicRoughness":this.detectConfig(e,i)}}}createEntity(e,t){let{mesh:n,name:r,matrix:i,rotation:a,scale:o,translation:s,skin:l,camera:c}=e;r=r||"node_"+t;let u=Ft.create(r),f=u.components.Transform;null!=i?(m(f.localMatrix,...i),qt.decomposeMatrix(f)):(null!=a&&le(f.quaternion,...a),null!=o&&w(f.scale,...o),null!=s&&w(f.translate,...s)),qt.updateMatrix(f);let h=[];if(null!=n){let e=u,t=this.gltf.meshes[n],r=t.length-1;for(let[n,i]of t.entries()){let[t,a]=i;r&&(e=u.appendChild(Ft.create("subNode_"+n))),e.addComponent(t),e.addComponent(a),h.push(e.components.Transform)}}return null!=l&&(this.gltf.skins[l].entity=u,this.gltf.skins[l].transforms||(this.gltf.skins[l].transforms=[]),this.gltf.skins[l].transforms.push(...h)),null!=c&&u.addComponent(this.gltf.cameras[c]),u}parseNode(e,t){let n=t[e],r=this.entities[e];if(n.children)for(let e of n.children)r.appendChild(this.parseNode(e,t));return r}}class Qt{constructor(e=1,t=45,n=.1,r=1e3){this.isDirty=!0,this.aspect=e,this.fov=t,this.near=n,this.far=r,this.projection=h(),this.view=h(),this.vp=h(),this.up=I(0,1,0),this.lookAt=O(),Qt.updateProjectionMatrix(this)}static updateProjectionMatrix(e){A(e.projection,e.fov*Math.PI/180,e.aspect,e.near,e.far)}static updateViewMatrix(e){let t=e.entity.components.Transform;R(e.view,t.translate,e.lookAt,e.up),S(e.view,e.view,t.worldInverseMatrix),S(e.vp,e.projection,e.view)}}Dt.registSystem(new class extends Pt{constructor(){super(...arguments),this.group=[],this.depends=[Qt.name]}onUpdate(){for(let{components:e}of this.group){let t=e.Camera;Qt.updateViewMatrix(t)}}});class Kt{static addTask(){this.totalTask++,this.taskObserve&&this.taskObserve(this.finishedTask,this.totalTask)}static finishTask(){this.finishedTask++,this.taskObserve&&this.taskObserve(this.finishedTask,this.totalTask)}static loadImage(e){return new Promise(((t,n)=>{this.addTask();let r=new Image;r.crossOrigin="anonymous",r.src=e,r.onload=()=>{t(r),this.finishTask()}}))}static loadBufferImage(e,t){return new Promise(((n,r)=>{var i=new Blob([e],{type:t}),a=URL.createObjectURL(i);let o=new Image;o.src=a,o.onload=()=>{n(o)}}))}static adjustDataUri(e,t){return"data:"==t.substr(0,5)?t:e+t}static glbParse(e){return kt(this,void 0,void 0,(function*(){let t,n=[],r=yield this.loadBuffer(e),i=0,a=new Int32Array(r,i,3);i+=12;let[o,s,l]=a;if(o==this.glbMagic){for(;i<l;){let[e,a]=new Int32Array(r,i,2);i+=8;let o=r.slice(i,i+e);switch(a){case 1313821514:t=JSON.parse(this.decoder.decode(o));break;case 5130562:n.push(o)}i+=e}return{json:t,bin:n}}console.error("Magic number incorrect! - "+a[0])}))}static loadGLTF(e,n,r,i,a){return kt(this,void 0,void 0,(function*(){let o,s=e.split("/"),[l,c]=s.pop().split(".");if(s=s.join("/")+"/","glb"==c){let t=yield this.glbParse(e);o=t.json,o.buffers=t.bin,o.bufferViews=o.bufferViews.map((e=>new Ot(o.buffers[e.buffer],e))),o.images&&(o.images=yield Promise.all(o.images.map((e=>this.loadBufferImage(o.bufferViews[e.bufferView].dataView,e.mimeType)))))}else{if("gltf"!=c)return void console.error("Wrong file!");o=yield(yield fetch(e)).json(),o.buffers=yield Promise.all(o.buffers.map((({uri:e})=>this.loadBuffer(this.adjustDataUri(s,e))))),o.bufferViews=o.bufferViews.map((e=>new Ot(o.buffers[e.buffer],e))),o.images&&(o.images=yield Promise.all(o.images.map((({uri:e})=>this.loadImage(this.adjustDataUri(s,e))))))}if(o.cameras&&(o.cameras=o.cameras.map((e=>{if(e.perspective){let{aspectRatio:t,yfov:r,znear:i,zfar:a}=e.perspective,o=new Qt(n.width/n.height,180*r/Math.PI,i,a);return o.name=e.name,o}}))),o.textures&&(o.textures=o.textures.map((e=>{let n,{source:r,sampler:i}=e;return null!=o.samplers&&(n=o.samplers[i]),new t(o.images[r],n)}))),o.commonShader=a||"iOS"==Wt.platform?new It(Nt.stylize.vs,Nt.stylize.fs):new It(Nt.stylize2.vs,Nt.stylize2.fs),void 0===this.brdfLUT){const e="https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Viewer/master/assets/images/lut_ggx.png";this.brdfLUT=yield this.loadTexture(e,{minFilter:WebGL2RenderingContext.LINEAR})}o.brdfLUT=this.brdfLUT,null!=r?(o.hasEnvmap=!0,o.envmap=r,o.diffmap=i):o.hasEnvmap=!1;let{scene:u}=yield new Jt(o).assemble(),f=Ft.getEntites([yt.name,Gt.name],u);for(let e of f){let t=e.components.Mesh,r=e.components.Material;"outline"==r.name&&(e.components.Transform.isVisible=!1),e.addComponent(new Vt(n,t,r))}return u}))}static loadBuffer(e){return kt(this,void 0,void 0,(function*(){this.addTask();let t=yield(yield fetch(e)).arrayBuffer();return this.finishTask(),t}))}static LoadShaderProgram(e){return kt(this,void 0,void 0,(function*(){let t=(e=Gt.SHADER_PATH+e)+".vs.glsl",n=e+".fs.glsl",[r,i]=yield Promise.all([t,n].map((e=>fetch(e).then((e=>e.text())))));return new It(r,i)}))}static LoadMaterial(e){return kt(this,void 0,void 0,(function*(){this.addTask();let t=yield this.LoadShaderProgram(e);return this.finishTask(),new Gt(t)}))}static HDRParse(e){const t=new Uint8Array(e);let n=0;for(;10!=t[n]||10!=t[n+1];)n++;let r=this.decoder.decode(t.subarray(0,n)).split("\n");"#?RADIANCE"!=r[0]&&console.table(r),n+=2;const i=n;for(;10!=t[++n];);let a=this.decoder.decode(t.subarray(i,n)).split(" "),o=t.subarray(n+1);a[1]*=1,a[3]*=1;const s=a[1]*a[3];let l=a[1],c=a[3],u=new Uint8Array(4*s),f=0;if(4*s!=o.length){console.time("RLE decoding");for(let e=0;e<l;e++){let t=o.subarray(f,f+4);if(f+=4,2!=t[0]||2!=t[1])console.log("this file is not run length encoded");else{const t=[new Uint8Array(c),new Uint8Array(c),new Uint8Array(c),new Uint8Array(c)];for(let e=0;e<4;e++){let n=0;const r=t[e];for(;n<c;){let e=0,t=o.subarray(f,f+2);if(f+=2,t[0]>128)for(e=t[0]-128;e--;)r[n++]=t[1];else for(e=t[0]-1,r[n++]=t[1];e--;)r[n++]=o.subarray(f,++f)[0]}}for(let n=0;n<c;n++){const r=u.subarray(4*(e*c+n),4*(e*c+(n+1)));r[0]=t[0][n],r[1]=t[1][n],r[2]=t[2][n],r[3]=t[3][n]}}}console.timeEnd("RLE decoding")}else for(let e=0;e<s;e++){const[t,n,r,i]=o.subarray(4*e,4*(e+1)),a=u.subarray(4*e,4*(e+1));a[0]=t,a[1]=n,a[2]=r,a[3]=i}return{size:a,buffer:u,decodeRGBE:()=>{const e=new Float32Array(3*s);for(let t=0;t<s;t++){const[n,r,i,a]=u.subarray(4*t,4*(t+1)),o=e.subarray(3*t,3*(t+1));0!=a&&(o[0]=n*Math.pow(2,a-128-8),o[1]=r*Math.pow(2,a-128-8),o[2]=i*Math.pow(2,a-128-8))}return{size:a,buffer:u,rgb:e}}}}static loadCubeimg(e,t="jpg"){return kt(this,void 0,void 0,(function*(){return yield Promise.all(this.cubemapOrder.map((n=>this.loadImage(e+n+t))))}))}static loadCubemap(e,n="jpg"){return kt(this,void 0,void 0,(function*(){let r;"hdr"==n?(r=yield Promise.all(this.cubemapOrder.map((t=>fetch(e+t+n)))),r=yield Promise.all(r.map((e=>e.arrayBuffer())))):r=yield this.loadCubeimg(e,n);let i=new t(r,{magFilter:WebGL2RenderingContext.LINEAR,minFilter:WebGL2RenderingContext.LINEAR_MIPMAP_LINEAR,wrapS:WebGL2RenderingContext.CLAMP_TO_EDGE,wrapT:WebGL2RenderingContext.CLAMP_TO_EDGE});if("hdr"==n){let e;i.data=r.map((t=>{const{size:n,buffer:r}=this.HDRParse(t);return e=n,r})),i.height=e[1],i.width=e[3],i.glType=WebGL2RenderingContext.TEXTURE_CUBE_MAP,i.image=null,i.isDirty=!0}return i}))}static loadTexture(e,n){return kt(this,void 0,void 0,(function*(){if("hdr"==e.split(".").pop()){let n=yield(yield fetch(e)).arrayBuffer();const{size:r,rgb:i}=this.HDRParse(n).decodeRGBE(),a=new t(null,{magFilter:WebGL2RenderingContext.LINEAR,minFilter:WebGL2RenderingContext.LINEAR,wrapS:WebGL2RenderingContext.CLAMP_TO_EDGE,wrapT:WebGL2RenderingContext.CLAMP_TO_EDGE});return a.data=i,a.height=r[1],a.width=r[3],a.format=WebGL2RenderingContext.RGB,a.internalformat=WebGL2RenderingContext.RGB32F,a.type=WebGL2RenderingContext.FLOAT,a.image=null,a.isDirty=!0,a}{let r=yield this.loadImage(e);return new t(r,n)}}))}}Kt.totalTask=0,Kt.finishedTask=0,Kt.taskObserve=null,Kt.glbMagic=1179937895,Kt.decoder=new TextDecoder,Kt.cubemapOrder=["posx.","negx.","posy.","negy.","posz.","negz."];let en="\nattribute vec3 POSITION;\n\nvoid main() {\n  gl_Position = vec4(POSITION, 1);\n}\n",tn="\nprecision highp float;\n#include <macros>\nuniform sampler2D base;\n\nvoid main() {\n    vec2 uv = gl_FragCoord.xy / screenSize;\n    vec4 color = texture2D(base, uv);\n    float brightness = dot(color.rgb, vec3(0.2126, 0.7152, 0.0722));\n    if(brightness < THRESHOLD) {\n        color.r = color.g = color.b = color.a = 0.0;\n        // discard;\n    }\n    gl_FragColor = color;\n}\n",nn="\nattribute vec3 POSITION;\n\nvoid main(){\n    gl_Position=vec4(POSITION,1);\n}\n",rn="\n#define PI 3.1415926535898\nprecision highp float;\nuniform sampler2D base;\n\nvec2 uv;\n\nvec4 blur9() {\n    vec4 color = vec4(0);\n    vec2 direction = OFFSET;\n    vec2 off1 = vec2(1.3846153846) * direction;\n    vec2 off2 = vec2(3.2307692308) * direction;\n    color += texture2D(base, uv) * 0.2270270270;\n    color += texture2D(base, uv + off1) * 0.3162162162;\n    color += texture2D(base, uv - off1) * 0.3162162162;\n    color += texture2D(base, uv + off2) * 0.0702702703;\n    color += texture2D(base, uv - off2) * 0.0702702703;\n    return color;\n}\nvec4 gaussianBlur() {\n    vec2 offset = OFFSET;\n    float weight[5];\n    weight[0] = 0.227027;\n    weight[1] = 0.1945946;\n    weight[2] = 0.1216216;\n    weight[3] = 0.054054;\n    weight[4] = 0.016216;\n    vec4 color = vec4(0);\n    for(int i = 0; i < 5; i++) {\n        color += texture2D(base, uv + offset * float(i+1) ) * weight[i];\n        color += texture2D(base, uv + offset * float(-i-1) ) * weight[i];\n    }\n    return color;\n}\n\nfloat random(vec3 scale, float seed) {\n    return fract(sin(dot(gl_FragCoord.xyz + seed, scale)) * 43758.5453 + seed);\n}\n\n// https://redcamel.github.io/RedGL2/example/postEffect/blur/RedPostEffect_BlurX.html\n\nvec4 noiseblur() {\n    vec4 finalColor = vec4(0);\n    vec2 delta;\n    float total = 0.0;\n    float offset = random(vec3(12.9898, 78.233, 151.7182), 0.0);\n    delta = OFFSET;\n    for (float t = -10.0; t <= 10.0; t++) {\n        float percent = (t + offset - 0.5) / 10.0;\n        float weight = 1.0 - abs(percent);\n        vec4 sample = texture2D(base, uv + delta * percent);\n        sample.rgb *= sample.a;\n        finalColor += sample * weight;\n        total += weight;\n    }\n    finalColor /= total;\n    return finalColor;\n}\n\nvoid main() {\n    uv = gl_FragCoord.xy / oResolution;\n    // gl_FragColor = gaussianBlur();\n    // gl_FragColor = noiseblur();\n    gl_FragColor = blur9();\n    // gl_FragColor = vec4(mod(uv, 1.), 0, 1);\n}\n",an="\nattribute vec3 POSITION;\n\nvoid main() {\n  gl_Position = vec4(POSITION, 1);\n}\n",on="\nprecision highp float;\n#include <macros>\nuniform sampler2D base;\nuniform sampler2D originTex;\n\nvoid main() {\n    vec2 uv = gl_FragCoord.xy / screenSize;\n    vec4 origin = texture2D(originTex, uv);\n    vec4 addition = texture2D(base, uv) * vec4(vec3(BLOOM_INTENSITY),0);\n    gl_FragColor = origin + addition;\n}\n";let sn=Nt.vignetting.vs,ln=Nt.vignetting.fs;class cn{constructor(e,t,n=90,r=90,i=.06,a=.88){this.movement=O(),this.unprojectMatrix=h(),this.X=I(1,0,0),this.Y=I(0,1,0),this.Z=I(0,0,1),this.vx=0,this.vy=0,this.vz=0,this.vyaw=0,this.vpitch=0,this.vscale=0,this.threshold=.01,this.moveHandler=(()=>{const e=O(),t=o(),n=t.subarray(0,3),r=t.subarray(3,6),i=t.subarray(6,9);return a=>{let{movementX:o,movementY:s,buttons:l}=a;if(2==l){w(e,-o,s,0),D(e,e,.001*this.distance);const a=this.trans.translate,l=this.camera.lookAt;$(i,l,a),z(i,i),k(n,i,this.camera.up),z(n,n),k(r,n,i),j(e,e,t),G(this.camera.lookAt,this.camera.lookAt,e),G(this.trans.translate,this.trans.translate,e)}else{let e=o*this.speed,t=-s*this.speed;this.vpitch+=t,this.vyaw+=e}}})(),this.touchHandler=()=>{let e,t;return n=>{let{pageX:r,pageY:i}=n.touches[0];if(e||t){let n=r-e,a=i-t;this.vpitch+=-a*this.speed,this.vyaw+=n*this.speed}t=i,e=r}},this.scrollHandler=({deltaY:e})=>{this.vscale+=e*this.speed*.01},this.orientationHandler=e=>{this.lastalpha&&this.lastbeta||(this.lastalpha=e.alpha,this.lastbeta=e.beta);let t=e.alpha-this.lastalpha,n=e.beta-this.lastbeta;this.pitch=this.lastbeta+.1*n,this.yaw=this.lastalpha+.1*t},this.pitch=n,this.yaw=r,this.speed=i,this.damping=a,this.camera=t.components.Camera,this.trans=t.components.Transform,this.distance=V(this.trans.translate,this.camera.lookAt),e.mainCamera=this.camera,cn.bindEvents(e.canvas,this),un.updatePosition(this)}static bindEvents(e,t){e.addEventListener("mousedown",(()=>{e.addEventListener("mousemove",t.moveHandler)})),e.addEventListener("mouseup",(()=>{e.removeEventListener("mousemove",t.moveHandler)})),e.addEventListener("wheel",t.scrollHandler),e.addEventListener("touchstart",(()=>{let n=t.touchHandler();e.addEventListener("touchmove",n),e.addEventListener("touchend",(()=>{e.removeEventListener("touchmove",n)}))})),e.addEventListener("wheel",t.scrollHandler),document.oncontextmenu=()=>!1}}class un extends Pt{constructor(){super(...arguments),this.group=[],this.depends=[cn.name]}onUpdate(){for(let{components:e}of this.group)un.updatePosition(e.OrbitControl)}static updatePosition(e){Math.abs(e.vyaw)>e.threshold&&(e.yaw+=e.vyaw,e.vyaw*=e.damping),Math.abs(e.vpitch)>e.threshold&&(e.pitch+=e.vpitch,e.vpitch*=e.damping),Math.abs(e.vscale)>e.threshold&&(e.distance+=e.vscale,e.distance=Math.max(e.distance,1),e.vscale*=e.damping),e.pitch=Math.min(180,Math.max(.01,e.pitch)),e.trans.translate[0]=e.camera.lookAt[0]+e.distance*Math.sin(e.pitch/180*Math.PI)*Math.cos(e.yaw/180*Math.PI),e.trans.translate[1]=e.camera.lookAt[1]+e.distance*Math.cos(e.pitch/180*Math.PI),e.trans.translate[2]=e.camera.lookAt[2]+e.distance*Math.sin(e.pitch/180*Math.PI)*Math.sin(e.yaw/180*Math.PI),e.camera.isDirty=!0,qt.updateMatrix(e.trans)}}Dt.registSystem(new un);class fn{constructor(e=0,t=0,n=0,r=0,i=0,a=0){this.max=O(),this.min=O(),this._center=O(),w(this.max,e,t,n),w(this.min,r,i,a)}pointInsert(e,t,n){return!(e>this.max[0]||e<this.min[0])&&(!(t>this.max[1]||t<this.min[1])&&!(n>this.max[2]||n<this.min[2]))}pointInsertX(e){return!(e>this.max[0]||e<this.min[0])}pointInsertY(e){return!(e>this.max[1]||e<this.min[1])}pointInsertZ(e){return!(e>this.max[2]||e<this.min[2])}isCross(e){return!(!this.pointInsertX(e.max[0])&&!this.pointInsertX(e.min[0]))&&(!(!this.pointInsertY(e.max[1])&&!this.pointInsertY(e.min[1]))&&!(!this.pointInsertZ(e.max[2])&&!this.pointInsertZ(e.min[2])))}update(){}reset(){w(this.max,0,0,0),w(this.min,0,0,0)}get visible(){return this._isVisible}set visible(e){if(this._isVisible=e,e&&!this.agent){this.agent=this.entity.appendChild(Ft.create("aabb"));const e=O();$(e,this.max,this.min);const t=this.createMesh(),n=new Vt(this.screen,t,fn.mat);this.agent.addComponent(n)}}createMesh(){const e=this.max[0],t=this.max[1],n=this.max[2],r=this.min[0],i=this.min[1],a=this.min[2];let o=new Float32Array([e,t,n,e,i,n,e,t,a,e,i,a,r,t,n,r,i,n,r,t,a,r,i,a]),s=new Uint16Array([0,1,2,2,1,3,6,7,4,4,7,5,6,4,2,2,4,0,5,7,1,1,7,3,4,5,0,0,5,1,2,3,6,6,3,7]),l=new Ot(o.buffer,{byteOffset:o.byteOffset,byteLength:o.byteLength,byteStride:12,target:WebGL2RenderingContext.ARRAY_BUFFER}),c=new Ot(s.buffer,{byteOffset:s.byteOffset,byteLength:s.byteLength,byteStride:0,target:WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER}),u=new Lt({bufferView:l,componentType:WebGL2RenderingContext.FLOAT,byteOffset:0,type:"VEC3",count:8},"POSITION"),f=new Lt({bufferView:c,componentType:WebGL2RenderingContext.UNSIGNED_SHORT,byteOffset:0,type:"SCALAR",count:s.length});return new yt([u],f,WebGL2RenderingContext.LINES)}append(e,t,n){this.max[0]=Math.max(this.max[0],e),this.max[1]=Math.max(this.max[1],t),this.max[2]=Math.max(this.max[2],n),this.min[0]=Math.min(this.min[0],e),this.min[1]=Math.min(this.min[1],t),this.min[2]=Math.min(this.min[2],n)}get center(){return this._center}}fn.mat=new Gt(new It(Nt.line.vs,Nt.line.fs));class hn{constructor(){this.data=[],this.child=[]}}class dn{constructor(){this.max=I(-1/0,-1/0,-1/0),this.min=I(1/0,1/0,1/0),this._center=O(),this.isDirty=!1,this._isVisible=!1}get center(){return this.isDirty&&this.updateCenter(),this._center}updateCenter(){this._center[0]=this.min[0]+.5*(this.max[0]-this.min[0]),this._center[1]=this.min[1]+.5*(this.max[1]-this.min[1]),this._center[2]=this.min[2]+.5*(this.max[2]-this.min[2]),this.isDirty=!1}update(e){this.isDirty=!0,this.max[0]=Math.max(this.max[0],e[0]),this.max[1]=Math.max(this.max[1],e[1]),this.max[2]=Math.max(this.max[2],e[2]),this.min[0]=Math.min(this.min[0],e[0]),this.min[1]=Math.min(this.min[1],e[1]),this.min[2]=Math.min(this.min[2],e[2])}get visible(){return this._isVisible}set visible(e){if(this._isVisible=e,e&&!this.agent){this.agent=this.root.appendChild(Ft.create("aabb"));const e=this.createMesh(),t=new Vt(this.screen,e,dn.mat);this.agent.addComponent(t)}}createMesh(){const e=this.max[0],t=this.max[1],n=this.max[2],r=this.min[0],i=this.min[1],a=this.min[2];let o=new Float32Array([e,t,n,e,i,n,e,t,a,e,i,a,r,t,n,r,i,n,r,t,a,r,i,a]),s=new Uint16Array([0,1,5,4,0,2,6,4,4,5,7,6,7,3,1,3,2]),l=new Ot(o.buffer,{byteOffset:o.byteOffset,byteLength:o.byteLength,byteStride:12,target:WebGL2RenderingContext.ARRAY_BUFFER}),c=new Ot(s.buffer,{byteOffset:s.byteOffset,byteLength:s.byteLength,byteStride:0,target:WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER}),u=new Lt({bufferView:l,componentType:WebGL2RenderingContext.FLOAT,byteOffset:0,type:"VEC3",count:8},"POSITION"),f=new Lt({bufferView:c,componentType:WebGL2RenderingContext.UNSIGNED_SHORT,byteOffset:0,type:"SCALAR",count:s.length});return new yt([u],f,WebGL2RenderingContext.LINE_LOOP)}}dn.mat=new Gt(new It(Nt.line.vs,Nt.line.fs));class mn{constructor(){this.bounds=new dn,this.isLeaf=!1,this.index=-1,this.mat=-1}get raw(){return new Float32Array(6)}static hitable(e,t){}}class vn{constructor(){this.bounds=new dn}}class pn{constructor(e=2048,n=1){const r=e*e,i=r/n,a=4*n,o=new Float32Array(4*r),s=[];for(let e=0;e<i;e++)s[e]=o.subarray(e*a,(e+1)*a);const l=new t(null,{magFilter:WebGL2RenderingContext.LINEAR,minFilter:WebGL2RenderingContext.LINEAR,wrapS:WebGL2RenderingContext.CLAMP_TO_EDGE,wrapT:WebGL2RenderingContext.CLAMP_TO_EDGE});l.data=o,l.height=e,l.width=e,l.format=WebGL2RenderingContext.RGBA,l.internalformat=WebGL2RenderingContext.RGBA32F,l.type=WebGL2RenderingContext.FLOAT,l.isDirty=!0,this.raw=o,this.chunks=s,this.tex=l}}class bn{constructor(e=2048){this.nodeList=[],this.matMap=new Map,this._size=O(),this.LBVHTexture=new pn(e,2),this.LBVH=this.LBVHTexture.raw,this.LBVH_nodes=this.LBVHTexture.chunks}genBounds(e,t=e.length,n){const r=[];let i=0;for(let a=0;a<t;){i<n.length-1&&a>=n[i+1][0]&&i++;const t=new vn;t.mat=n[i][1],t.index=2*a,t.bounds.update(e[a++]),t.bounds.update(e[a++]),t.bounds.update(e[a++]),r.push(t)}return r}materialsHandler(e){let t="",n="\n        if(mat < -.5) {\n            continue;\n        }";let r=[];for(const[i,[a,o]]of e){const e=o.textures;let s="sRGBtoLINEAR(texture(ground, iuv * 40.)).rgb";"Logo1"==i?s="vec3(.3, .5, 1)":"Logo2"==i&&(s="vec3(.9, .7, .12)");let l=`\n            // float scale = 100.;\n            // float fact = step(.0, sin(iuv.x * scale)*sin(iuv.y * scale));\n            // albedo = vec3(1) * clamp(fact, .2, 1.);\n            // albedo = sRGBtoLINEAR(texture(ground, iuv * .3)).rgb;\n            albedo = ${s};\n`;e.has("baseColorTexture")&&r.length<11&&(t+=`\nuniform sampler2D baseColorTexture_${a};\n`,l=`albedo = sRGBtoLINEAR(texture(baseColorTexture_${a}, iuv)).rgb;`,r.push((t=>{Gt.setTexture(t,"baseColorTexture_"+a,e.get("baseColorTexture")[1])})));let c="\n            vec3 rm = vec3(0, .01, .12);\n            metal = clamp(rm.b, 0.0, 1.0);\n            roughness = clamp(1. - rm.g, 0.04, 1.0);\n            ";e.has("metallicRoughnessTexture")&&r.length<11&&(t+=`\nuniform sampler2D metallicRoughnessTexture_${a};\n`,c=`\n                vec3 rm = texture(metallicRoughnessTexture_${a}, iuv).rgb;\n                metal = clamp(rm.b, 0.0, 1.0);\n                roughness = clamp(rm.g, 0.04, 1.0);\n`,r.push((t=>{Gt.setTexture(t,"metallicRoughnessTexture_"+a,e.get("metallicRoughnessTexture")[1])})));let u="";e.has("emissiveTexture")&&r.length<11&&(t+=`\nuniform sampler2D emissiveTexture_${a};\n`,u=`\n                vec3 em = sRGBtoLINEAR(texture(emissiveTexture_${a}, iuv)).rgb;\n                if(dot(em, em) > .01)\n                    return em;\n`,r.push((t=>{Gt.setTexture(t,"emissiveTexture_"+a,e.get("emissiveTexture")[1])}))),n+=`\n            else if(mat < ${a}.5) { // NOTE: ${i}\n                ${l}\n                ${c}\n                ${u}\n            }`}return{params:t,route:n,init:e=>{for(let t of r)t(e)}}}buildBVH(e){console.time("Build BVH");let t=[];const n=new pn(2048,2);let r=0;const i=O(),a=ie();for(let o of e){const e=o.entity.components.Material;let s=-1;this.matMap.has(e.name)?[s]=this.matMap.get(e.name):(s=this.matMap.size,this.matMap.set(e.name,[this.matMap.size,e])),t.push([r,s]);let l=o.entity.components.Transform,c=o.data,u=c.POSITION,f=c.NORMAL,h=c.TEXCOORD_0,d=o.indices.data;for(let e=0;e<d.length;e++){const t=n.chunks[r++];if(q(i,u[d[e]],l.worldMatrix),t.set(i),f){const n=f[d[e]];le(a,n[0],n[1],n[2],0),xe(a,a,l.worldNormalMatrix),z(a,a),t.set(a,4)}h&&(t[3]=h[d[e]][0],t[7]=h[d[e]][1])}}const o=this.genBounds(n.chunks,r,t),s=this.root=this.splitBVH(o),l=this.fillLBVH(s,this.LBVHTexture),c=this.materialsHandler(this.matMap);return console.timeEnd("Build BVH"),{LBVH:l,triangleTexture:n,primitives:o,matHandler:c}}splitBVH(e){if(0==e.length)return null;const t=new mn;for(let n of e)t.bounds.update(n.bounds.max),t.bounds.update(n.bounds.min);if(e.length<2)return t.isLeaf=!0,t.index=e[0].index,t.mat=e[0].mat,t;const n=this._size;$(n,t.bounds.max,t.bounds.min);let r=n.indexOf(Math.max(n[0],n[1],n[2])),i=[],a=[],o=3;for(;o--&&(0==i.length||0==a.length);){const n=t.bounds.center[r%3];i=[],a=[];for(let t of e)t.bounds.center[r]<n?i.push(t):a.push(t);if(r++,0==o){const t=Math.ceil(e.length/2);i=e.slice(0,t),a=e.slice(t)}}if(0==i.length&&a.length,0==i.length){const e=i;i=a,a=e}return t.left=this.splitBVH(i),t.right=this.splitBVH(a),t}static createTree(e){let t=new mn;return e--?(t.left=this.createTree(e),t.right=this.createTree(e)):t.isLeaf=!0,t}fillLBVH(e,t){return t.raw.fill(0),bn.fillLinearNode(e,t.chunks),t}static fillLinearNode(e,t,n=0){let r=e.right?n+1:-1;return e.left&&(r=this.fillLinearNode(e.left,t,n+1)),t[n].set(e.bounds.min),t[n].set(e.bounds.max,4),e.isLeaf?t[n][3]=e.mat:t[n][3]=r,t[n][7]=e.index,n++,e.right&&(n=this.fillLinearNode(e.right,t,r)),n}}e.AABB=dn,e.Accessor=Lt,e.Animation=Zt,e.AnimationChannel=$t,e.Asset=Kt,e.BVHManager=bn,e.Bloom=class{static initFilters(e,t=.7,n=1,r=1){let i;i={THRESHOLD:t};let a=new Ut(e,new It(en,tn,i)),o=e.width,s=e.height,l=[];n=1*e.ratio;let c=3;for(2;c--&&o>32&&s>32;){const t=Math.floor(.5*o),r=Math.floor(.5*s);l.push(new Ut(e,new It(nn,rn,{OFFSET:`vec2(${n/t}, 0)`,iResolution:`vec2(${o}, ${s})`,oResolution:`vec2(${t}, ${r})`}),o=t,s=r)),l.push(new Ut(e,new It(nn,rn,{OFFSET:`vec2(0, ${n/r})`,iResolution:`vec2(${o}, ${s})`,oResolution:`vec2(${t}, ${r})`}),o=t,s=r))}i={BLOOM_INTENSITY:"float(2)"};let u=new Ut(e,new It(an,on,i));e.output?u.setInput(e.output.output,"originTex"):u.setInput(e.capture.output,"originTex"),e.attachFilter(a);for(let t of l)e.attachFilter(t),console.log(t.width,t.height);e.attachFilter(u)}},e.BoxMesh=class extends yt{constructor(e=1,t=1,n=1){e/=2,t/=2,n/=2;let r=new Float32Array([e,t,n,e,-t,n,e,t,-n,e,-t,-n,-e,t,n,-e,-t,n,-e,t,-n,-e,-t,-n]),i=new Uint16Array([0,1,2,2,1,3,6,7,4,4,7,5,6,4,2,2,4,0,5,7,1,1,7,3,4,5,0,0,5,1,2,3,6,6,3,7]),a=new Ot(r.buffer,{byteOffset:r.byteOffset,byteLength:r.byteLength,byteStride:12,target:WebGL2RenderingContext.ARRAY_BUFFER}),o=new Ot(i.buffer,{byteOffset:i.byteOffset,byteLength:i.byteLength,byteStride:0,target:WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER});super([new Lt({bufferView:a,componentType:WebGL2RenderingContext.FLOAT,byteOffset:0,type:"VEC3",count:8},"POSITION")],new Lt({bufferView:o,componentType:WebGL2RenderingContext.UNSIGNED_SHORT,byteOffset:0,type:"SCALAR",count:i.length}),WebGL2RenderingContext.LINES)}},e.Camera=Qt,e.ComponentSystem=Pt,e.EntityMgr=Ft,e.Filter=Ut,e.Material=Gt,e.Mesh=yt,e.MeshRenderer=Vt,e.OrbitControl=cn,e.QuadMesh=class extends yt{constructor(){let e=new Float32Array([-1,-1,0,0,0,0,0,1,1,-1,0,1,0,0,0,1,1,1,0,1,1,0,0,1,-1,1,0,0,1,0,0,1]),t=new Uint16Array([0,1,2,0,2,3]),n=new Ot(e.buffer,{byteOffset:e.byteOffset,byteLength:e.byteLength,byteStride:32,target:WebGL2RenderingContext.ARRAY_BUFFER}),r=new Ot(t.buffer,{byteOffset:t.byteOffset,byteLength:t.byteLength,byteStride:0,target:WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER});super([new Lt({bufferView:n,componentType:WebGL2RenderingContext.FLOAT,byteOffset:0,type:"VEC3",count:4},"POSITION"),new Lt({bufferView:n,componentType:WebGL2RenderingContext.FLOAT,byteOffset:12,type:"VEC2",count:4},"TEXCOORD_0"),new Lt({bufferView:n,componentType:WebGL2RenderingContext.FLOAT,byteOffset:20,type:"VEC3",count:4},"NORMAL")],new Lt({bufferView:r,componentType:WebGL2RenderingContext.UNSIGNED_SHORT,byteOffset:0,type:"SCALAR",count:6}))}},e.Screen=Wt,e.Shader=It,e.Skin=jt,e.System=Dt,e.Texture=t,e.Transform=Xt,e.UniformInfo=Ct,e.Vignetting=class extends Ut{constructor(e,t=.4,n=1){super(e,new It(sn,ln,{FACTOR:`float(${t})`,HARDNESS:`float(${n})`,iResolution:`vec2(${e.width*e.ratio}, ${e.height*e.ratio})`,oResolution:`vec2(${e.width*e.ratio}, ${e.height*e.ratio})`}))}},e.bufferView=Ot,e.glsl=Nt,e.mat3=f,e.mat4=L,e.octree=class{constructor(e,t){if(this.maxLength=200,this.temp=new fn,this.screen=t,!e)return void console.error("Mesh not found!");this.entity=e.entity,this.data=e.data,this.pos=this.data.POSITION,this.face=e.indices.data;let n=new hn;n.bound=new fn,n.bound.entity=this.entity,n.bound.screen=this.screen;let r=[];for(let e=0,t=this.face.length/3;e<t;e++){r.push(e);let t,i=3*e;t=this.pos[this.face[i++]],n.bound.append(t[0],t[1],t[2]),t=this.pos[this.face[i++]],n.bound.append(t[0],t[1],t[2]),t=this.pos[this.face[i++]],n.bound.append(t[0],t[1],t[2])}n.bound.visible=!0,this.tree=this.buildNode(null,r,n.bound)}visible(e=this.tree){if(e&&!(e.data.length<this.maxLength)){e.bound.visible=!0;for(let t of e.child)this.visible(t)}}trangleIntersection(e,t){this.temp.reset();let n,r=3*e;return n=this.pos[this.face[r++]],this.temp.append(n[0],n[1],n[2]),n=this.pos[this.face[r++]],this.temp.append(n[0],n[1],n[2]),n=this.pos[this.face[r++]],this.temp.append(n[0],n[1],n[2]),t.isCross(this.temp)}buildNode(e,t,n){let r=new hn;if(r.bound=n,n.entity=this.entity,n.screen=this.screen,r.data=t,!t)return null;if(t.length<this.maxLength)return r.data=t,r;const{max:i}=n,{min:a}=n;let o=(i[0]-a[0])/2+a[0],s=(i[1]-a[1])/2+a[1],l=(i[2]-a[2])/2+a[2],c=[new fn(i[0],i[1],i[2],o,s,l),new fn(i[0],i[1],l,o,s,a[2]),new fn(o,i[1],l,a[0],s,a[2]),new fn(o,i[1],i[2],a[0],s,l),new fn(i[0],s,i[2],o,a[1],l),new fn(i[0],s,l,o,a[1],a[2]),new fn(o,s,l,a[0],a[1],a[2]),new fn(o,s,i[2],a[0],a[1],l)];for(let n of c){let i=[];for(let e of t)this.trangleIntersection(e,n)&&i.push(e);if(e&&i.length&&i.length==e.data.length){r.child.push(null);break}r.child.push(this.buildNode(r,i,n))}return r}},e.quat=ct,e.vec2=St,e.vec3=re,e.vec4=Ce,e.version="0.4.1",Object.defineProperty(e,"__esModule",{value:!0})}));
//# sourceMappingURL=/sm/15d643c24ad81dd0c7a204191f2b14e9c4a61924557f0f2d0740ea20535201d1.map