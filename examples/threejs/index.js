...
import { HDRCubeTextureLoader } from '../../libs/three.js/r132/examples/jsm/loaders/HDRCubeTextureLoader.js';
import { KTX2Loader } from './../../libs/three.js/r132/examples/jsm/loaders/KTX2Loader.js';
...
function init() {
    ...
    const dracoLoader = new DRACOLoader().setDecoderPath( '../../libs/three.js/r132/examples/js/libs/draco/gltf/' );
    loader.setDRACOLoader( dracoLoader );

    const ktx2Loader = new KTX2Loader().setTranscoderPath( '../../libs/three.js/r132/examples/js/libs/basis/' );
