...
import * as THREE from '../../libs/three.js/r126dev/build/three.module.js';
import { GUI } from '../../libs/three.js/r126dev/examples/jsm/libs/dat.gui.module.js';
import { OrbitControls } from '../../libs/three.js/r126dev/examples/jsm/controls/OrbitControls.js';
import { GLTFLoader } from '../../libs/three.js/r126dev/examples/jsm/loaders/GLTFLoader.js';
import { DRACOLoader } from '../../libs/three.js/r126dev/examples/jsm/loaders/DRACOLoader.js';
import { RGBELoader } from '../../libs/three.js/r126dev/examples/jsm/loaders/RGBELoader.js';
import { HDRCubeTextureLoader } from '../../libs/three.js/r126dev/examples/jsm/loaders/HDRCubeTextureLoader.js';
import { KTX2Loader } from './../../libs/three.js/r126dev/examples/jsm/loaders/KTX2Loader.js';
...
function init() {
    ...
    const dracoLoader = new DRACOLoader().setDecoderPath( '../../libs/three.js/r126dev/examples/js/libs/draco/gltf/' );
    loader.setDRACOLoader( dracoLoader );

    const ktx2Loader = new KTX2Loader().setTranscoderPath( '../../libs/three.js/r126dev/examples/js/libs/basis/' );
