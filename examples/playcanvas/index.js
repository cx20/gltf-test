...
*/
    ...
    app.assets.loadFromUrl(
        "../../libs/playcanvas/v1.44.1/orbit-camera.js",
        "script",
        function (err, asset) {
...
function main(){
    if (wasmSupported()) {
        loadWasmModuleAsync('DracoDecoderModule', '../../libs/playcanvas/v1.44.1/draco.wasm.js', '../../libs/playcanvas/v1.44.1/draco.wasm.wasm', startViewer);
    } else {
        loadWasmModuleAsync('DracoDecoderModule', '../../libs/playcanvas/v1.44.1/draco.js', '', startViewer);
    }
}
