...
*/
    ...
    app.assets.loadFromUrl(
        "../../libs/playcanvas/v1.39.3/orbit-camera.js",
        "script",
        function (err, asset) {
...
function main(){
    if (wasmSupported()) {
        loadWasmModuleAsync('DracoDecoderModule', '../../libs/playcanvas/v1.39.3/draco.wasm.js', '../../libs/playcanvas/v1.39.3/draco.wasm.wasm', startViewer);
    } else {
        loadWasmModuleAsync('DracoDecoderModule', '../../libs/playcanvas/v1.39.3/draco.js', '', startViewer);
    }
}
