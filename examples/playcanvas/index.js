...
*/
    ...
    app.assets.loadFromUrl(
        "../../libs/playcanvas/v1.44.0-dev/orbit-camera.js",
        "script",
        function (err, asset) {
...
function main(){
    if (wasmSupported()) {
        loadWasmModuleAsync('DracoDecoderModule', '../../libs/playcanvas/v1.44.0-dev/draco.wasm.js', '../../libs/playcanvas/v1.44.0-dev/draco.wasm.wasm', startViewer);
    } else {
        loadWasmModuleAsync('DracoDecoderModule', '../../libs/playcanvas/v1.44.0-dev/draco.js', '', startViewer);
    }
}
