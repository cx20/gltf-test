...
TutorialExtensionTestModelIndex.List = [
    ...
    {category:'tutorialModels', name:'AnisotropyDiscTest', scale:0.5},
    {category:'tutorialModels', name:'AnisotropyRotationTest', scale:0.5},
    {category:'tutorialModels', name:'AnisotropyStrengthTest', scale:0.3},
    {category:'tutorialModels', name:'AttenuationTest', scale:0.2},
    {category:'tutorialModels', name:'AudioSimple', scale:1.0},
    {category:'tutorialModels', name:'CarbonFibre', scale:2.0},
    {category:'tutorialModels', name:'CarbonFrameBike', scale:1.0},
    {category:'tutorialModels', name:'ChairDamaskPurplegold', scale:3.0},
    ...
    {category:'tutorialModels', name:'DiffuseTransmissionPlant', scale:3.0},
    {category:'tutorialModels', name:'DiffuseTransmissionTeacup', scale:10.0},
    {category:'tutorialModels', name:'DirectionalLight', scale:5.0},
    {category:'tutorialModels', name:'DispersionTest', scale:20.0},
    {category:'tutorialModels', name:'DragonAttenuation', scale:1.0},
    {category:'tutorialModels', name:'DragonDispersion', scale:1.0},
    ...
    {category:'tutorialModels', name:'GlassBrokenWindow', scale:4.0},
    {category:'tutorialModels', name:'GlassHurricaneCandleHolder', scale:5.0},
    {category:'tutorialModels', name:'GlassVaseFlowers', scale:10.0},
    {category:'tutorialModels', name:'IORTestGrid', scale:5.0},
    {category:'tutorialModels', name:'IridescenceAbalone', scale:15.0},
    ...
    {category:'tutorialModels', name:'MandarinOrange', scale:150.0},
    ...
    {category:'tutorialModels', name:'PotOfCoals', scale:30.0},
    ...
    {category:'tutorialModels', name:'SheenTestGrid', scale:5.0},
    {category:'tutorialModels', name:'SpecGlossVsMetalRough', scale:10.0},
    {category:'tutorialModels', name:'SpecularSilkPouf', scale:5.0},
    ...
    {category:'tutorialModels', name:'TransmissionThinwallTestGrid', scale:0.2},
    {category:'tutorialModels', name:'UnlitTest', scale:1.0},
    {category:'tutorialModels', name:'XmpMetadataRoundedCube', scale:0.1}
];
